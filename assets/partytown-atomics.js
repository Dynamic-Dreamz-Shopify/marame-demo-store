...
(e => {
    const t = () => {},
        ...
        n = e => {
            ...
            try {
                const t = null === (n = null === (r = null == e ? void 0 : e.__zone_symbol__originalInstance) || void 0 === r ? void 0 : r.constructor) || void 0 === n ? void 0 : n.name;
                if (t) return t;
            } catch (e) {}
            return "";
        },
        i = (e, t) => e.startsWith(t),
        o = e => !(i(e, "webkit") || i(e, "toJSON") || i(e, "constructor") || i(e, "toString") || i(e, "_")),
        s = e => (11 === e.nodeType && e.host ? "#s" : e.nodeName),
        a = () => Math.round(Math.random() * Number.MAX_SAFE_INTEGER).toString(36),
        c = { Anchor: "a", DList: "dl", Image: "img", OList: "ol", Paragraph: "p", Quote: "q", TableCaption: "caption", TableCell: "td", TableCol: "colgroup", TableRow: "tr", TableSection: "tbody", UList: "ul" },
    ...
    !(function (e) {
        ...
        (function (e) {
            (e[(e.PushState = 0)] = "PushState"), (e[(e.ReplaceState = 1)] = "ReplaceState"), (e[(e.PopState = 2)] = "PopState"), (e[(e.HashChange = 3)] = "HashChange");
        })(v || (v = {})),
        (function (e) {
            (e[(e.Window = 0)] = "Window"), (e[(e.Element = 1)] = "Element"), (e[(e.AttributeNode = 2)] = "AttributeNode"), (e[(e.TextNode = 3)] = "TextNode"), (e[(e.CDataSectionNode = 4)] = "CDataSectionNode"), (e[(e.Function = 5)] = "Function"), (e[(e.Property = 6)] = "Property"), (e[(e.ProcessingInstructionNode = 7)] = "ProcessingInstructionNode"), (e[(e.CommentNode = 8)] = "CommentNode"), (e[(e.Document = 9)] = "Document"), (e[(e.DocumentTypeNode = 10)] = "DocumentTypeNode"), (e[(e.DocumentFragmentNode = 11)] = "DocumentFragmentNode"), (e[(e.EnvGlobalConstructor = 12)] = "EnvGlobalConstructor");
        })(w || (w = {})),
        (function (e) {
        ...
        (function (e) {
            (e[(e.Primitive = 0)] = "Primitive"), (e[(e.Array = 1)] = "Array"), (e[(e.Object = 2)] = "Object"), (e[(e.Instance = 3)] = "Instance"), (e[(e.Ref = 4)] = "Ref"), (e[(e.Event = 5)] = "Event"), (e[(e.Function = 6)] = "Function"), (e[(e.NodeList = 7)] = "NodeList"), (e[(e.ArrayBuffer = 8)] = "ArrayBuffer"), (e[(e.ArrayBufferView = 9)] = "ArrayBufferView"), (e[(e.Attr = 10)] = "Attr"), (e[(e.CSSRule = 11)] = "CSSRule"), (e[(e.CSSRuleList = 12)] = "CSSRuleList"), (e[(e.CSSStyleDeclaration = 13)] = "CSSStyleDeclaration"), (e[(e.Error = 14)] = "Error");
        })($ || ($ = {})),
        (function (e) {
            (e.Body = "BODY"), (e.Comment = "#comment"), (e.Document = "#document"), (e.DocumentElement = "HTML"), (e.DocumentTypeNode = "html"), (e.DocumentFragment = "#document-fragment"), (e.IFrame = "IFRAME"), (e.Head = "HEAD"), (e.Script = "SCRIPT"), (e.Text = "#text");
        })(N || (N = {})),
        (function (e) {
            (e.errorHandlers = "error"), (e.loadHandlers = "load"), (e[(e.src = 0)] = "src"), (e[(e.loadErrorStatus = 1)] = "loadErrorStatus"), (e[(e.cssRules = 2)] = "cssRules"), (e[(e.innerHTML = 3)] = "innerHTML"), (e[(e.url = 4)] = "url"), (e[(e.type = 5)] = "type");
        })(E || (E = {})),
        (function (e) {
            (e[(e.Blocking = 1)] = "Blocking"), (e[(e.NonBlocking = 2)] = "NonBlocking"), (e[(e.NonBlockingNoSideEffect = 3)] = "NonBlockingNoSideEffect");
        })(T || (T = {}));
    const C = (e, t) => {
        ...
        R = (e, t, r, n, i) => {
            if ((r = f[e]) && r.U) {
                if (e === t) return r.U;
                if (((n = r.U.document), (i = t.split(".").pop()) === b.document)) return n;
    ...
    const A = e.parent,
                ...
                "connectedCallback,disconnectedCallback,attributeChangedCallback,adoptedCallback".split(",").map(
                    r =>
                        (n.prototype[r] = function (...n) {
                            t.postMessage([S.CustomElementCallback, e, C(this), r, n]);
                        })
                ),
        ...
        B = (e, t, r, o, a, c) => (void 0 !== t && (o = typeof t) ? ("string" === o || "number" === o || "boolean" === o || null == t ? [$.Primitive, t] : "function" === o ? [$.Function] : (r = r || new Set()) && Array.isArray(t) ? (r.has(t) ? [$.Array, []] : r.add(t) && [$.Array, t.map(t => B(e, t, r))]) : "object" === o ? (j(t) ? [$.Error, { name: t.name, message: t.message, stack: t.stack }] : "" === (a = n(t)) ? [$.Object, {}] : "Window" === a ? [$.Instance, [e, e]] : "HTMLCollection" === a || "NodeList" === a ? [$.NodeList, Array.from(t).map(t => B(e, t, r)[1])] : a.endsWith("Event") ? [$.Event, D(e, t, r)] : "CSSRuleList" === a ? [$.CSSRuleList, Array.from(t).map(W)] : i(a, "CSS") && a.endsWith("Rule") ? [$.CSSRule, W(t)] : "CSSStyleDeclaration" === a ? [$.CSSStyleDeclaration, D(e, t, r)] : "Attr" === a ? [$.Attr, [t.name, t.value]] : t.nodeType ? [$.Instance, [e, C(t), s(t), c]] : [$.Object, D(e, t, r, !0, !0)]) : void 0) : t),
        D = (e, t, r, i, s, a, c, l) => {
            if (((a = {}), !r.has(t))) for (c in (r.add(t), t)) o(c) && ((l = "path" === c && n(t).endsWith("Event") ? t.composedPath() : t[c]), (i || "function" != typeof l) && (s || "" !== l) && (a[c] = B(e, l, r)));
            return a;
        },
        W = e => {
            let t,
    ...
    const j = t => {
        ...
        U = (t, r, n, i) => (r ? ((n = r[0]), (i = r[1]), n === $.Primitive ? i : n === $.Ref ? F(t, i) : n === $.Array ? i.map(e => U(t, e)) : n === $.Instance ? R(i[0], i[1]) : n === $.Event ? V(z(t, i)) : n === $.Object ? z(t, i) : n === $.ArrayBuffer ? i : n === $.ArrayBufferView ? new e[r[2]](i) : void 0) : void 0),
        F = (e, { V: t, w: r, L: n }, i) => (
            (i = g.get(n)) ||
                ((i = function (...i) {
                    e.postMessage([S.RefHandlerCallback, { V: t, w: r, L: n, R: B(t, this), b: B(t, i) }]);
                }),
                g.set(n, i)),
            i
        ),
            ...
            for (; d < u; d++)
                try {
                    (c = d === u - 1),
                        ...
                        o[0] === I.GlobalConstructor && o[1] in f[i].U ? L(new f[i].U[o[1]](...U(e, o[2])), n.w) : ((s = R(i, n.w)), s ? ((a = J(e, i, s, o, c, n.r)), n.d && ("string" == typeof n.d ? L(a, n.d) : (f[n.d.V] = { V: n.d.V, U: { document: a } })), "object" == typeof (p = a) && p && p.then && ((a = await a), c && (l.z = !0)), c && (l.M = B(i, a, void 0, void 0, void 0, n.w))) : (l.p = n.w + " not found"));
                } catch (e) {
                ...
                try {
                    if (!Array.isArray(c))
                        if ("string" == typeof l || "number" == typeof l) {
                            ...
                            if ("function" == typeof i[u] && ((d = U(e, l)), "define" === u && "CustomElementRegistry" === n(i) && (d[1] = H(t, e, d[1])), "insertRule" === u && d[1] > r(i.cssRules) && (d[1] = r(i.cssRules)), (i = i[u].apply(i, d)), "play" === u)) return Promise.resolve();
                        }
                } catch (e) {
                    if (s) throw e;
                    console.debug(e);
        ...
        G = (e, t) => {
            ...
            c && c.body
                ? ((n = c.querySelector(p)),
                  ...
                  n
                      ? ((n.dataset.ptid = i = C(n, s)), (o = { V: s, w: i }), n.src ? ((o.S = n.src), (o.H = n.dataset.ptsrc || n.src)) : (o.j = n.innerHTML), e.postMessage([S.InitializeNextScript, o]))
                      : (t.x ||
                            ((t.x = 1),
                            ((e, t, n) => {
                                let i,
                                    ...
                                    c = (r, n) => e.postMessage([S.ForwardMainTrigger, { V: t, q: r, b: B(t, Array.from(n)) }]);
                                if (
                                    ((n._ptf = void 0),
                                    a.map(e => {
                                                        ...
                                                        : (() => {
                                                              ...
                                                              if (i) {
                                                                  const { methodOrProperty: t, thisObject: r } = ((e, t) => {
                                                                      ...
                                                                      return { thisObject: r, methodOrProperty: t.length > 0 ? r[t[t.length - 1]] : void 0 };
                                                                  })(n, s);
                        ...
                        e.postMessage([S.InitializedScripts, s])))
        ...
        K = (e, t, r) => {
            if (!y.has(r)) {
                ...
                const a = [],
                    ...
                    l = () => {
                        e.postMessage([S.InitializeEnvironment, { V: t, J: o, S: n.baseURI, T: n.visibilityState }]),
                            setTimeout(() => {
                                (s = !0),
                                    a.forEach(e => {
                                        e();
                    ...
                    p = (r, i, o, s) => () => {
                        e.postMessage([S.LocationUpdate, { V: t, type: r, state: i, url: n.baseURI, newUrl: o, oldUrl: s }]);
                    };
                (i.pushState = (e, t, r) => {
                    u(e, t, r), c(p(v.PushState, e, null == r ? void 0 : r.toString()));
                }),
                    (i.replaceState = (e, t, r) => {
                        d(e, t, r), c(p(v.ReplaceState, e, null == r ? void 0 : r.toString()));
                    }),
                    r.addEventListener("popstate", e => {
                        c(p(v.PopState, e.state));
                    }),
                    r.addEventListener("hashchange", e => {
                        c(p(v.HashChange, {}, e.newURL, e.oldURL));
                    }),
                    r.addEventListener("ptupdate", () => {
                        G(e, f[t]);
                    }),
                    n.addEventListener("visibilitychange", () => e.postMessage([S.DocumentVisibilityState, t, n.visibilityState])),
                    (f[t] = { V: t, U: r }),
        ...
        Y = () => {
            const e = Object.getOwnPropertyNames(A)
                .map(e =>
                    ((e, t, r, n) => {
                        if ((r = t.match(/^(HTML|SVG)(.+)Element$/))) return (n = r[2]), "S" == t[0] ? e.createElementNS("http://www.w3.org/2000/svg", l[n] || n.slice(0, 2).toLowerCase() + n.slice(2)) : e.createElement(c[n] || n);
                    })(M, e)
                )
                .filter(e => !(!e || ("HTMLUnknownElement" === n(e) && "UNKNOWN" !== e.nodeName.toUpperCase())))
                .map(e => [e]);
            return X(e, []);
        },
        X = (e, t) => {
        ...
        ee = (e, t, r, i, s, a) => {
            try {
                o(r) && isNaN(r[0]) && "all" !== r && ("function" == (s = typeof (i = t[r])) ? (String(i).includes("[native") || Object.getPrototypeOf(t)[r]) && e.push([r, w.Function]) : "object" === s && null != i ? "Object" !== (a = n(i)) && "Function" !== a && self[a] && e.push([r, i.nodeType || a]) : "symbol" !== s && (r.toUpperCase() === r ? e.push([r, w.Property, i]) : e.push([r, w.Property])));
            } catch (e) {
                console.warn(e);
            }
        },
    ...
    (async e => {
        ...
        return (n, i) => {
            const o = i[0],
                s = i[1];
            if (o === S.MainDataRequestFromWorker) {
                const e = (() => {
                    const e = M.createElement("i"),
                        ...
                        c = A.performance,
                        l = A.screen,
                        u = [[A.history], [c], [c.navigation], [c.timing], [l], [l.orientation], [A.visualViewport], [o, w.EnvGlobalConstructor], [s, w.EnvGlobalConstructor], [a, w.EnvGlobalConstructor], [t], [r], [n], [i], [e], [e.attributes], [e.classList], [e.dataset], [e.style], [M], [M.doctype]],
                        d = [Z("Window", A), Z("Node", t)],
                        p = (function (e) {
                            return JSON.stringify(e, (e, t) => ("function" == typeof t && (t = String(t)).startsWith(e + "(") && (t = "function " + t), "loadScriptsOnMainThread" === e && (t = t.map(e => (Array.isArray(e) ? e : ["string" == typeof e ? "string" : "regexp", "string" == typeof e ? e : e.source]))), t));
                        })(x),
                        m = { i: p, v: X(u, d), C: new URL(P, A.location) + "", I: origin, $tabId$: A._pttab };
                    return (
                        ((e, t, r) => {
                            void 0 !== t[r] && e.push([r, "Object", Object.keys(t[r].prototype).map(e => [e, w.Property]), w.EnvGlobalConstructor]);
                        })(m.v, A, "IntersectionObserverEntry"),
                        m
                    );
                })();
                (e.P = t), n.postMessage([S.MainDataResponseToWorker, e]);
            } else
                i[0] === S.MainInterfacesRequestFromWorker
                    ? n.postMessage([S.MainInterfacesResponseToWorker, Y()])
                    : o === S.ForwardWorkerAccessRequest
                      ? e(s, e => {
                      ...
                      : ((e, t, r) => {
                            t[0] === S.InitializedWebWorker
                                ? K(e, a(), A)
                                : (r = f[t[1]]) &&
                                  (t[0] === S.InitializeNextScript
                                      ? requestAnimationFrame(() => G(e, r))
                                      : t[0] === S.InitializedEnvironmentScript &&
                                        ((e, t, r, n, i) => {
                                            (i = t.U.document.querySelector(`[data-ptid="${r}"]`)) && (n ? (i.dataset.pterror = n) : (i.type += "-x"), delete i.dataset.ptid), G(e, t);
                                        })(e, r, t[2], t[3]));
                        })(n, i);
        };
        ...
        e &&
            ...
            (re.onmessage = t => {
                const r = t.data;
                r[0] === S.AsyncAccessRequest ? _(re, r[1]) : e(re, r);
            }),
            A.addEventListener("pt1", e => K(re, C(e.detail.frameElement), e.detail)));
    });
})(window);
