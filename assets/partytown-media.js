            ...
            const o = {
                                    ...
                                    ? "function" == typeof h[t]
                                        ? (...e) => {
                                              if (t.startsWith("create")) {
                                                  const o = s();
                                                  return r(f, [t], e, R.NonBlocking, o), "createImageData" === t || "createPattern" === t ? ((n = `${t}()`), console.warn(`${n} not implemented`), { setTransform: () => {} }) : new l(i, o);
                                              }
                                              var n;
                                        ...
                                        : h[t]
                                    : e[t],
                            set: (e, t, r) => ("string" == typeof t && t in h ? (h[t] !== r && "function" != typeof r && n(f, [t], r), (h[t] = r)) : (e[t] = r), !0),
                        };
                ...
                g = (e, t, o) => {
                    const i = e[a],
                        ...
                        h = { get: (e, t) => ("string" == typeof t ? ("function" != typeof f[t] ? f[t] : (...e) => r(l, [t], e, p(t))) : e[t]), set: (e, t, r) => ("string" == typeof t && t in f ? (f[t] !== r && "function" != typeof r && n(l, [t], r), (f[t] = r)) : (e[t] = r), !0) };
                    return new Proxy(f, h);
                },
                m = "checkFramebufferStatus,makeXRCompatible".split(","),
                p = e => (e.startsWith("create") || e.startsWith("get") || e.startsWith("is") || m.includes(e) ? R.Blocking : R.NonBlocking);
