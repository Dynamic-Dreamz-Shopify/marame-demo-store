  ...
  customElements.define(
    ...
    class LocalizationForm extends HTMLElement {
      ...
      hidePanel() {
        ...
        if(this.header.preventHide) this.header.preventHide = false;
      }
      ...
      openSelector() {
        ...
        document.body.toggleAttribute("data-lenis-prevent");
        document.documentElement.toggleAttribute("data-lenis-prevent");
